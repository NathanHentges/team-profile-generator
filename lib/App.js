...
class App {
  ...
  finishApp() {
    // Generate a html card for each team member, given certain attritutes based on manager/engineer/intern
    const genCards = this.team.reduce(
      (acc, member) => {
    ...
    genHTML.writeHTML(distHTMLtext);
  }
}
